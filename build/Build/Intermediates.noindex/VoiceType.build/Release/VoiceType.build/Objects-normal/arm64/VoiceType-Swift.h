...
#ifndef VOICETYPE_SWIFT_H
#define VOICETYPE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VoiceType",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9VoiceType11AppDelegate")
...
SWIFT_CLASS("_TtC9VoiceType13FloatingPanel")
